...
Welcome to the Final Year repository! This guide will help you understand the collaboration workflow and best practices for working on this project.
...
```
git remote add origin https://github.com/Talal-Amjad/ShopLink
```
4. Pull or Clone code from the master branch
```
git pull origin master OR git clone https://github.com/Talal-Amjad/ShopLink
```
